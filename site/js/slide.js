...
//função mundança de estado
function Mudarestado(el, al ,cl) {
        var display = document.getElementById(el).style.display;
        var display2 = document.getElementById(al).style.display;
        var display3 = document.getElementById(cl).style.display;
        if(display == "none")
